...
<div class="sidebar">
    <ul class="widget widget-menu unstyled">
        ...
        <li><a href="{{ URL::route('category.index')}}"><i class="menu-icon icon-bullhorn"></i>Categories</a></li>
        <li><a href="{{ URL::route('event.index')}}"><i class="menu-icon icon-bullhorn"></i>Events</a></li>
